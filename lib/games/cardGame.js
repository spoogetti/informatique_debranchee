...
class CardGame extends Phaser.Scene {
    ...
    preload () {
        // this.load.spritesheet('fancyCards', fCards, this.cardSpriteDims);
    }
    ...
    create (data)  {
        ...
        this.validateButton = this.add.text(this.fourthW, (this.cardAmount + 1) * this.heightH, 'Victory check button', { fill: '#000' })
            .setInteractive()
